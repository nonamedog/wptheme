...
function followandrew_register_styles() {
    ...
    wp_enqueue_style('followandrew-style', get_template_directory_uri() . "/style.css", array 
...
function followandrew_register_scripts() {
   ...
   'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js', array(), '3.4.1', true);

   wp_enqueue_script('followandrew-main', 
   get_template_directory_uri(). "/js/main.js", array(), '1.0', true);
...
<!--
Funckijas izsauksana
// apg_getUrl('images/logo.png')

http://localhost/wordpress/wp-content/themes/followandrew 
-->
